...
const {teacherController, teachercreate, teacherview, teacherupdate, teacherdelete, myClasses} = require("../../controllers/teacher/teacherConteroller");
...
router.get("/my-classes", authMiddle, authorized(["teacher"]), myClasses);
